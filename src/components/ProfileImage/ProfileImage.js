...
export class ProfileImage extends Component {
  ...
  render() {
    const { profileImage }  = this.props.location.pathname === '/React-form-registration/register' ? '' : this.props.profile;
    return (
      <div className="leftPanel">
        ...
        {
          this.props.location.pathname !== '/React-form-registration/register' && getStore('user') && <button className="link-button" onClick={this.logout}>Logout</button>
        }
        {
         this.props.location.pathname === '/React-form-registration/register' && <button className="link-button" onClick={this.logout}>Log In</button>
        }
      </div>
    )
  }

...
export class Login extends Component {
  ...
  validateForm = () => {
    let valid = false;
    if (this.props.profile && this.props.profile.username === this.state.username && this.props.profile.password === this.state.password) {
      valid = true
    } else {
      this.state.errors.username = 'Enter Valid User Name'
      this.state.errors.password = 'Enter Valid Password'
    }
    return valid;
  }
